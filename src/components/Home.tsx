...
const buttons = [
  ...
  <Tooltip key={"github"} title="Go to Novalia.s Github">
    <IconButton color="primary" key="two" href="https://github.com/Novalia9517">
      <GitHubIcon />
    </IconButton>
  </Tooltip>,
  <Box
      ...
      >
        ...
        >
            ...
            <Fade in={open}>
              <Box sx={style} width={{ md: 400, xs: "70%", sm: "60%" }}>
                ...
                <Typography
                  ...
                  mt={3}
                >
                  ATS Version is for CV which ATS friendly. And Creative version
                  for creative CV with colors.
                </Typography>
                <Stack spacing={4} direction="row" mt={3}>
                  <Button
                    ...
                    size="small"
                    color={"primary"}
                    href="https://drive.google.com/uc?export=download&id=1j5tCDSEOy8dYhdCQ0mh-sx7Dr0eBh_bJ"
                    // https://drive.google.com/file/d/1j5tCDSEOy8dYhdCQ0mh-sx7Dr0eBh_bJ/view?usp=sharing
                    sx={{ textAlign: "center" }}
                  >
                    ATS Version
                  </Button>
                  <Button
                    ...
                    size="small"
                    color="primary"
                    href="https://drive.google.com/uc?export=download&id=1fmoklYbm45vWnsVU7BG8uHXzVrqMnCrc"
                    // https://drive.google.com/file/d/1fmoklYbm45vWnsVU7BG8uHXzVrqMnCrc/view?usp=sharing
                    sx={{ textAlign: "center" }}
                  >
                    Creative Version
                  </Button>
          ...
          <Box
            ...
            sx={{
              backgroundImage:
                "linear-gradient(to right bottom, #64b5f6,  #5e35b1)",
